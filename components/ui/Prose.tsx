  ...
  return (
    <div
      className={cn(
        ...
        // citazioni
        "[&_blockquote]:my-6 [&_blockquote]:border-l-4 [&_blockquote]:border-orange [&_blockquote]:bg-cream-50 [&_blockquote]:py-2 [&_blockquote]:pl-5 [&_blockquote]:text-ink-soft [&_blockquote]:italic",
        // enfasi e codice
